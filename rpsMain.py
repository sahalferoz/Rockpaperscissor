...
Label(text = 'Simple Game', font = font.Font(size = 20), bg = 'white').pack()
Label(text = 'Rock Paper Scissors', font = font.Font(size = 20), bg = 'white').pack()
...
player_options = Label(input_frame, text = "Your Options : ", font = app_font, fg = 'grey', bg = 'white')
...
score_label = Label(input_frame, text = 'Score : ', font = app_font, fg = 'grey', bg = 'white')
score_label.grid(row = 2, column = 0)

player_choice_label = Label(input_frame, text = 'Your Selected : ---', font = app_font, bg = 'white')
